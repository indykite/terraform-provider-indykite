...
// Remove once golangci-lint is fixed
replace github.com/junk1tm/musttag v0.6.1 => go.tmz.dev/musttag v0.6.1
...
require (
	...
	github.com/indykite/indykite-sdk-go v0.12.0
...
require (
	...
	github.com/junk1tm/musttag v0.6.1 // indirect
