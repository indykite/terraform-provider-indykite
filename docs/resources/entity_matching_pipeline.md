...
- `source_node_type_filter` (String) Source node type to be used in the entity matching pipeline.
- `target_node_type_filter` (String) Target node type to be used in the entity matching pipeline.
...
- `entity_matching_result` (String) Entity matching result.
